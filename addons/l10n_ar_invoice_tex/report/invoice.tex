...
<%!
from openerp.addons.l10n_ar_invoice_tex.report.invoice import take, flatdate, is_class, cuit_format, codename_format, type_format
%>
...
%% INVOICE INFORMATION
	...
	\codename{${codename_format(o)}}
	\codeid{${'%02i' % o.journal_id.journal_class_id.afip_code}}
	\type{${type_format(o)}}
	\pointofsale{${'%04i' % o.journal_id.point_of_sale}}
	\invnumber{${'%08i' % int(take(o.number, prefix=o.journal_id.sequence_id.prefix, suffix=o.journal_id.sequence_id.suffix))}}
	...
	\customerdocument{${(lambda dt: dt.name if dt.afip_code != 99 else 'Documento')(o.partner_id.document_type_id)}}%
			 {${(lambda dt, dn: cuit_format(dn) if dn and dt.afip_code == 80 else (dt.name if dt.afip_code == 99 else dn))(o.partner_id.document_type_id, o.partner_id.document_number)}}
